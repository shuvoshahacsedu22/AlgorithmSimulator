...
function AnimationManager(objectManager)
{
	...
	this.startNextBlock = function()
	{
		...
		{			
            ...
            if (nextCommand[0] == "StopAnimation"){
            	oldAnimationBlockLenght=this.animationBlockLength;
            	this.animationBlockLength=0;
			}
			else if(nextCommand[0] == "RestoreAnimation"){
            	this.animationBlockLength=oldAnimationBlockLenght;
			}
