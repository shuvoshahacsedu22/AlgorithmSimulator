...
StackArray.prototype.setup = function()
{
	...
	for (var i = 0; i < SIZE; i++)
	{
		...
		this.cmd("SetForegroundColor", this.arrayLabelID[i], "#000000");
...
StackArray.prototype.pushCallback = function(event)
{
	if (this.top < SIZE && this.pushField.value != "")
	{
		...
		this.implementAction(this.stackFull.bind(this),"The Stack is full")
	}
}
		
StackArray.prototype.stackFull=function(){

    this.cmd("CreateLabel", labPushID, "Cannot Push Value; ", PUSH_LABEL_X, PUSH_LABEL_Y);
    this.cmd("Step");
...
StackArray.prototype.pop = function(ignored)
{
	...
	this.cmd("CreateHighlightCircle", this.highlight1ID, "#ff0000",  TOP_POS_X, TOP_POS_Y);
	this.cmd("Step");
